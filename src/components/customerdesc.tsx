        ...
        <section className="py-[150px]">
            <div className="w-[94%] max-w-[600px] mx-auto flex flex-col gap-[70px]">
                <div>
                    ...
                    <p className="font-[200] text-[18px] text-gray-600">Technology is changing. From archives to floppy discs. Floppy discs to cloud. At Spaak, we focus on the frontier of technology, working to push the boundaries of what is possible in knowledge tools.
                        <br></br><br></br>
                ...
                <div>
                    ...
                    <p className="font-[200] text-[18px] mb-[40px] text-gray-600">Technology is changing. From archives to floppy discs. Floppy discs to cloud. At Spaak, we focus on the frontier of technology, working to push the bound.
                    </p>
